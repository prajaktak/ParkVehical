...
//                        }
    ...
    func post(data: NSDictionary , path:String , completion:((Error?,String) -> Void)?) {
        var myDict: NSDictionary?
        if let path = Bundle.main.path(forResource: "API", ofType: "plist") {
            myDict = NSDictionary(contentsOfFile: path)
        }
        ...
        if let dict = myDict{
            ...
            do {
                let jsonData = try JSONSerialization.data(withJSONObject: data, options: JSONSerialization.WritingOptions.sortedKeys)
    ...
    func patch(data: NSDictionary , path:String , completion:((Error?,String) -> Void)?) {
        var myDict: NSDictionary?
        if let path = Bundle.main.path(forResource: "API", ofType: "plist") {
            myDict = NSDictionary(contentsOfFile: path)
        }
